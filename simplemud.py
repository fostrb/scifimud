...
rooms = {
    "Tavern": {
        "description": "You're in the cyber tavern",
        "exits": {"outside": "Outside", "void": "Void"}
    },
    "Outside": {
        "description": "You're outside the cyber tavern",
        "exits": {"inside": "Tavern"}
    },
    "Void": {
        "description": "You're in the fucking void.",
...
while True:
    ...
    for id in mud.get_disconnected_players():
        ...
        mud.log("{} quit the game".format(players[id]["name"]))
        del(players[id])
    ...
    for id, command, params in mud.get_commands():
        ...
        if players[id]["name"] is None:
            ...
            for pid, pl in players.items():
                ...
                mud.log("{} entered the game".format(players[id]["name"]))
            # send the new player a welcome message
            mud.send_message(id, "Welcome to the net, {}. ".format(
                                                           players[id]["name"])
        ...
        # 'go' command
            ...
            for pid, pl in players.items():
                mud.send_message(id, "logout not yet implemented. hit ctrl+C")
